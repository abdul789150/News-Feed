...
const LoginCard = ({ updateState, className,...divProps }) => {
    ...
    >
      <div className="flex flex-col space-y-4">
        ...
        <div className=''>
          <button 
            type="submit" 
            className="w-full flex justify-center mt-16 text-white bg-indigo-600 hover:bg-indigo-600 focus:ring-indigo-300 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center"
          ...
          <div className="text-sm font-medium text-gray-500 mt-4">
              Not registered? <span onClick={() => updateState('signUp')} className="text-indigo-700 hover:underline cursor-pointer">Create account</span>
          </div>
        </div>
      </div>
    </div>
